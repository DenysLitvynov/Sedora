...
public class FAQ extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        faqItemList.add(new FAQItem("¿Qué servicios ofrecemos?", "En Sedora, ofrecemos un conjunto de servicios diseñados para mejorar la ergonomía en el trabajo:\n" +
                "\n" +
        ...
        faqItemList.add(new FAQItem("¿Métodos de pago?", "Ofrecemos la posibilidad de pago mediante transferencia bancaria, pago con tarjeta, bizum o PayPal"));
        faqItemList.add(new FAQItem("¿Hay soporte fuera de horarios?", "El soporte de nuestra aplicación se encuentra disponible de 8 a 20 horas de lunes a viernes"));
        faqItemList.add(new FAQItem("¿Es seguro compartirmis datos?", "Si, es seguro puesto que gestionamos los datos nosotros mismos y nos los dejamos en manos de terceros, encuentra más información sobre qué y para qué usamos tus datos en las politicas de privacidad y consentimiento"));
        faqItemList.add(new FAQItem("¿Puedo añadir más sensores?", "Inicialmente, Sedora está pensado para ser una solución completa a los problemas ergonómicos del día a día de nuestros usuarios. Por lo que la aplicación no está concevida para soportar nuevos sensores. Si crees que se debería añadir un nuevo sensor o funcionalidad, por favor haznoslo saber mediante el correo de contacto sedorainfo@sedora.es y estudiaremos la propuesta."));
        faqItemList.add(new FAQItem("¿Cómo puedo contactar con el equipo de soporte?", "Para contactar con el servicio técnico de Sedora, puede escribir a sedoraincidencias@sedora.es "));
