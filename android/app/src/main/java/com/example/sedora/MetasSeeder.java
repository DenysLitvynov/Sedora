...
public class MetasSeeder {
    ...
    public static void seedMetas() {
        ...
        metas.add(new Meta("Mantente correcto 1 h", "Mantén una posición correcta durante 1 hora.", 1, 0, "icono_sentado", 1, "actual"));
        metas.add(new Meta("¡No trabajes tanto!", "Levántate de la silla al menos 5 veces en un día.", 5, 0, "levantarse", 2, "pendiente"));
        metas.add(new Meta("¡Mantente correcto 2 h!", "Mantén tu posición correcta durante 2 horas.", 2, 0, "icono_sentado", 3, "pendiente"));
        metas.add(new Meta("Trabaja con luz suficiente", "No recibas alertas por falta de luz durante 1 hora.", 1, 0, "icono_iluminacion", 4, "pendiente"));
        metas.add(new Meta("Trabaja con luz suficiente II", "No recibas alertas por falta de luz durante 2 horas.", 2, 0, "icono_iluminacion", 5, "pendiente"));
        metas.add(new Meta("Perfecto por 3 horas", "Mantén una postura perfecta sin recibir alertas durante 3 horas seguidas.", 3, 0, "icono_sentado2", 6, "pendiente"));
        metas.add(new Meta("No todo es trabajo", "Levántate de la silla al menos 3 veces en 4 horas.", 3, 0, "levantarse", 7, "pendiente"));
        metas.add(new Meta("Mantente correcto 4 h", "Mantén una postura correcta durante 4 horas.", 4, 0, "icono_sentado2", 8, "pendiente"));
        metas.add(new Meta("Aprovecha la luz natural", "No recibas alertas por falta de luz durante 3 horas.", 3, 0, "icono_iluminacion", 9, "pendiente"));
